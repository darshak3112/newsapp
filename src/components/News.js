...
return (
  <>
    <h1 className="text-center" style={{ margin: '35px 0px',marginTop:'90px' }}>News Monkey -- Top headlines from {Capitalize(props.category)} </h1>
    {loading && <Spinner />}
    <InfiniteScroll
      ...
      loader={<Spinner />}
    >
      <div className="contanier my-3" style={{ margin: '50px 150px' }}>
        <div className="row" >
